...
@Component({
  selector: 'app-basic-geographies',
  standalone: true,
  imports: [
    CommonModule,
    VicMapChartModule,
  ...
  templateUrl: './basic-geographies.component.html',
  styleUrls: ['./basic-geographies.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class BasicGeographiesComponent {
