...
@Component({
  selector: 'app-single-panel-display',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './single-panel-display.component.html',
  styleUrls: [
    '../example-display.scss',
    './single-panel-display.component.scss',
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class SinglePanelDisplayComponent extends ExampleDisplay {
