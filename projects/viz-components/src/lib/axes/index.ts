...
export * from './x-ordinal/x-ordinal-axis.module';
...
export * from './x-quantitative/x-quantitative-axis.module';
...
export * from './y-ordinal/y-ordinal-axis.module';
...
export * from './y-quantitative-axis/y-quantitative-axis.module';
