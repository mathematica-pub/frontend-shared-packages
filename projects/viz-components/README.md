...
Run `ng build viz-components` to build the project. The build artifacts will be stored in the `dist/` directory.

## Publishing

After building your library with `ng build viz-components`, go to the dist folder `cd dist/viz-components` and run `npm publish`.
