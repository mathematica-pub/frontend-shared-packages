...
export type QdQnCDatum = { continent: string; population: number; year: Date };
// Quant Number, Quant Number, Cat
export type QnQnCDatum = {
  continent: string;
  population: number;
  year: number;
};
export const QdQnCData: QdQnCDatum[] = [
...
export const QnQnCData: QnQnCDatum[] = QdQnCData.map((d) => ({
  ...d,
