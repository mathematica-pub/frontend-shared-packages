...
```builder-method
pre: One of the following methods must be called to set the fill color of the circles.
methods:
  - name: fill
...
```builder-method
pre: One of the following methods must be called to set the radius of the circles.
methods:
  - name: radius
...
```builder-method
pre: One of the following methods must be called to set the x position of the circles.
methods:
  - name: xDate
...
```builder-method
pre: One of the following methods must be called to set the y position of the circles.
methods:
  - name: yDate
